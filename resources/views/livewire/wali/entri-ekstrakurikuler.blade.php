            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label fw-semibold">
                        ...
                        Pilih Ekstrakurikuler <span class="text-danger">*</span>
                    </label>
            ...
            <tbody>
                ...
                <tr wire:key="pelajar-{{ $pelajar->pelajar_id }}">
                    ...
                    <td>
                        ...
                        <small>{{ Str::limit($pelajar->deskripsi_sekarang, 100) }}</small>
                        @else
                        <span class="text-muted">-</span>
                        @endif
                    </td>
                    <td>
                        @if($pelajar->nilai_sekarang || $pelajar->deskripsi_sekarang)
                        <button type="button"
